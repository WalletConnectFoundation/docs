...
| --- | --- |
| Wallets | Earn interchange on every payment routed through WCPay — modelled on card network interchange |
...
WCPay is designed around the opposite principle: lead with incentives on every side. The result is a self-reinforcing flywheel — more payments generate more fees, more fees fund better rewards, better rewards drive more payments.
