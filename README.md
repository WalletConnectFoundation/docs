...
- **Mainnet**: Under active development — launch when audited & ready (Q2 2026 target)  
- **Testnet**: Public beta Q1 2026  
- **Tokens**: No live contracts yet — all addresses will be announced post-audit  
- **Live Today**: ACCXBot for wallet creation & testing → https://t.me/accxbot  

This repo will house verified assets for the ACCX ecosystem once deployed. Community contributions welcome after testnet.

## Planned Assets (42 African Digital Assets)
When mainnet launches, this will include:  
- **ACCX**: Native governance/utility token (BEP-20 on BSC)  
...
All will have: logos, decimals (18), symbols, socials, and verified contracts.
...
**Process (future)**:  
1. Fork this repo  
2. Add `info.json` in `/blockchains/bsc/assets/` (template below)  
