...
**WalletConnect** enables custodians like BitGo to offer curated, policy-enforced access to decentralized finance (DeFi) through a secure, modular SDK.
...
Sp this represents how much money actually flows through the WalletConnect.
...
<img src="/images/tnv.png" alt="Total Network Volume" />
