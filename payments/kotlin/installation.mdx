...
Its important that you register the UI callbacks and delegate them before triggering a payment, or you risk missing early events like  `onQRShow`.
...
`Connected` you can use this state to show a loading spinner indicating that they payment request will follow. To display the QR code follow:
