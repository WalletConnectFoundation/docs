...
```kotlin
 val projectId = "your_project_id" // Obtain your project ID from the dashboard.walletconnect.com
...
- **Project ID** from the Reown Dashboard ([dashboard.walletconnect.com](http://dashboard.walletconnect.com)) .
