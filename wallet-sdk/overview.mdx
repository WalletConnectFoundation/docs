...
**Wallet SDK** is WalletConnect's modular SDK for integrating secure, multichain, policy-aligned wallet access directly into your infrastructure. Enable your wallet’s users to securely connect to any app, powered by the WalletConnect Network
...
<Frame>
  ![WalletKit banner](https://mintlify.s3.us-west-1.amazonaws.com/reown-5552f0bb/images/walletkit.png)
</Frame>
