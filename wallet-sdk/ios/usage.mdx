...
**[Initialization](#initialization)**: Creating a new WalletKit instance and initializing it with a projectId from [WalletConnect Dashboard](https://dashboard.reown.com).
...
To enable or disable verification find the **Verify SDK** toggle in your project [WalletConnect Dashboard](https://dashboard.reown.com).
