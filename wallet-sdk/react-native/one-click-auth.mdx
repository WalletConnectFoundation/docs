...
<Frame>
  <img alt="Mobile Linking Connect Flow" className="block dark:hidden" src="https://mintlify.s3.us-west-1.amazonaws.com/reown-5552f0bb/images/w3w/authenticatedSessions-dark.png" />
  <img alt="Mobile Linking Connect Flow" className="hidden dark:block" src="https://mintlify.s3.us-west-1.amazonaws.com/reown-5552f0bb/images/w3w/authenticatedSessions-light.png" />
</Frame>
