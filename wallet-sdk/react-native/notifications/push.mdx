...
For the push notifications to be forwarded to FCM or APNs, the [Push Server](https://docs.reown.com/advanced/push-server) will need to be configured with your FCM or APNs server API credentials.
