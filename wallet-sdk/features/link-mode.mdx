...
<CardGroup cols={2}>
    <Card title="Android" icon="android" href="/wallet-sdk/android/link-mode">
        Get started with Link Mode in WalletKit - Android.
    </Card>
    <Card title="iOS" icon="apple" href="/wallet-sdk/ios/link-mode">
        Get started with Link Mode in WalletKit - iOS.
    </Card>
    <Card title="Flutter" icon="flutter" href="/wallet-sdk/flutter/link-mode">
        Get started with Link Mode in WalletKit - Flutter.
    </Card>
    <Card title="React Native" icon="react" href="/wallet-sdk/react-native/link-mode">
